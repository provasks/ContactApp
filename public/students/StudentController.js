...
universityApp.controller('StudentController', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.editStudent = function (c) {
        try {
            var student = {_id: c._id, name: c.name, email: c.email, password:c.password, contact: c.contact};
